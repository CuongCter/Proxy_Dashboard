...
import { apiLogout } from "../services/api_helper";
const NavBar = () => {
  const arrSideBar = [
    {
      id: 1,
      ...
      <div className="layoutDetail">
        <div className="layoutDetail__main">
          <div className="layoutDetail__main-sidebar">
            <div className="logoProxy">PROXY LOGO</div>
            {arrSideBar.map((itemMenu, index) => (
              <div
                key={index}
                className={`menu-sidebar ${
                  selectMenu.id === index + 1 ? "active" : ""
                }`}
          ...
          <div onClick={logout} className="layoutDetail__main-logout">
